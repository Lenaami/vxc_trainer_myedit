...
# -------
## DropClass
parser.add_argument('--use_dropclass',  type=bool,  default=False,  help='DropClass');
parser.add_argument('--its_per_drop',   type=int,   default=1000,   help='Number of iterations');
parser.add_argument('--num_drop',       type=int,   default=2000,   help='Number of drop');
# -------
